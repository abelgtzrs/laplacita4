  ...
  const foodItems = [
    {
      ...
      description: "Tamales hechos a mano con masa de maíz y rellenos auténticos",
      price: "$2.50",
    ...
    },
    {
      ...
      description: "Cerdo cocido lentamente con especias tradicionales mexicanas",
      price: "$12.99/lb",
      image: "/placeholder.svg?height=300&width=400",
      category: "Carnes",
    ...
    {
      name: "Mole Poblano",
      description: "Pollo bañado en auténtico mole poblano con más de 20 ingredientes",
      price: "$13.99",
      image: "/placeholder.svg?height=300&width=400",
      category: "Tradicional",
      available: "Domingos",
  ...
  const specialties = [
    {
      ...
      description: "Preparamos comida fresca todos los días con recetas familiares tradicionales.",
      icon: Heart,
    },
    {
      title: "Pedidos Especiales",
      description: "Acepta pedidos especiales para eventos y celebraciones familiares.",
      icon: Star,
    },
    {
      title: "Ingredientes Frescos",
      description: "Utilizamos solo los ingredientes más frescos y auténticos disponibles.",
      icon: Utensils,
    },
  ]
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">{t("food.title")}</h1>
          <h2 className="text-2xl text-red-600 font-semibold mb-4">{t("food.subtitle")}</h2>
          <div className="w-24 h-1 bg-gradient-to-r from-green-500 to-red-500 mx-auto mb-6"></div>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">{t("food.description")}</p>
        </div>
        ...
        <Card className="border-2 border-yellow-400">
          <CardContent className="p-8 text-center">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Servicios de Catering</h2>
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              ¿Planeas una fiesta o evento especial? Ofrecemos servicios de catering para bodas, quinceañeras,
              cumpleaños y eventos corporativos. Comida auténtica que hará de tu evento algo memorable.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <div className="flex items-center justify-center space-x-2 text-green-600">
                <span className="font-semibold">📞 Llama para cotizar: (772) 123-4567</span>
              </div>
            </div>
          </CardContent>
        </Card>
