    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">{t("promotions.title")}</h1>
        ...
        {promotions.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {promotions.map((promotion: any) => {
              ...
              return (
                <Card
                  key={promotion.id}
                  className={`overflow-hidden hover:shadow-lg transition-shadow ${isActive ? "border-2 border-green-500" : "border-2 border-gray-200"}`}
                >
                  {promotion.image_url && (
                    ...
                    {isActive && (
                      <div className="mt-4 p-3 bg-green-50 border border-green-200 rounded-lg">
                        <div className="flex items-center text-green-700">
                          ...
                          <span className="font-semibold">¡Promoción activa!</span>
                        </div>
                      </div>
                    )}
                  </CardContent>
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-gray-600 mb-2">{t("promotions.no_active")}</h3>
            <p className="text-gray-500">Mantente atento a nuestras redes sociales para conocer las últimas ofertas.</p>
          </div>
        )}
        ...
        <Card className="mt-12 bg-gradient-to-r from-yellow-400 to-orange-500 text-white">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-xl mb-6 max-w-2xl mx-auto">
              Síguenos en Facebook y WhatsApp para recibir notificaciones de nuestras promociones especiales y ofertas
              exclusivas para la comunidad.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <div className="flex items-center justify-center space-x-2">
                <span className="font-semibold">📘 Facebook: La Placita FTP</span>
              </div>
              <div className="flex items-center justify-center space-x-2">
                <span className="font-semibold">📱 WhatsApp: (772) 123-4567</span>
              </div>
            </div>
          </CardContent>
        </Card>
